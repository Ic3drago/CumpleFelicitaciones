...
<body>
  <header id="header" class="header d-flex align-items-center">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            method="POST">
                ...
                <div  class="form-text">
                    Escribe un nombre con el que Ninel te pueda identificar
                </div>
                ...
                <div  class="form-text">
                    Un apodo o algo para que Ninel te identifique, puede ser una palabra, la escuela donde estudias o donde se conocieron
                </div>
                ...
                <div  class="form-text">
                    Escribe un mensaje de felicitaciones para Ninel. Max 400 caracteres
                </div>
                <label for="imagen" class="form-label  label-txt">Foto o Video</label>
                <input type="file" name="imagen" class="form-control">
                <div  class="form-text">
                    Opcional. Si subes un video, ten paciencia, puede tardar unos minutos.
                </div>
    ...
    </main><a href="#" class="scroll-top d-flex align-items-center justify-content-center"><i
  ...
  <script>
    document.querySelector('form').addEventListener('submit', function(e) {
        ...
        // Cambia el texto del botón y lo deshabilita para evitar doble click
        btn.innerHTML = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Subiendo... (Por favor espera)';
        btn.disabled = true;
    });
  </script>
